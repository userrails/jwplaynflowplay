"undefined" == typeof jwplayer && (jwplayer = function(h) {
    if (jwplayer.api)
        return jwplayer.api.selectPlayer(h)
}, jwplayer.version = "6.10.4892", jwplayer.vid = document.createElement("video"), jwplayer.audio = document.createElement("audio"), jwplayer.source = document.createElement("source"), function(h) {
    function c(f) {
        return function() {
            return a(f)
        }
    ...
    e.getAbsolutePath = function(f, a) {
        ...
        if (e.exists(f)) {
            ...
            for (var d = [], c = 0; c < b.length; c++)
                b[c] && (e.exists(b[c]) && "." != b[c]) && (".." == b[c] ? d.pop() : d.push(b[c]));
            return k + m + "/" + d.join("/")
        }
    };
    e.extend = function() {
        ...
        if ("undefined" != typeof g.ActiveXObject)
            try {
                if (a = new g.ActiveXObject("ShockwaveFlash.ShockwaveFlash"))
                    return parseInt(a.GetVariable("$version").split(" ")[1].split(",")[0],
                            10)
            } catch (m) {
            }
        return 0
    ...
    e.foreach = function(f, a) {
        var k, m;
        for (k in f)
            "function" == e.typeOf(f.hasOwnProperty) ? f.hasOwnProperty(k) && (m = f[k], a(k, m)) : (m = f[k], a(k, m))
    };
    e.isHTTPS = function() {
    ...
    e.ajax = function(f, a, k, m) {
        ...
        if (f && 0 <= f.indexOf("://") && f.split("/")[2] != g.location.href.split("/")[2] &&
            ...
            b = new g.XDomainRequest, b.onload = l(b, f, a, k, m), b.ontimeout = b.onprogress = function() {
            }, b.timeout = 5E3;
    ...
    e.parseXML = function(a) {
        ...
        try {
            if (g.DOMParser) {
                if (b = (new g.DOMParser).parseFromString(a, "text/xml"), b.childNodes && b.childNodes.length && "parsererror" == b.childNodes[0].firstChild.nodeName)
                    return
            } else
                b = new g.ActiveXObject("Microsoft.XMLDOM"), b.async = "false", b.loadXML(a)
        } catch (k) {
            return
        }
        return b
    ...
    e.filterPlaylist = function(a, b, k) {
        ...
        for (d = 0; d < a.length; d++)
            if (c = e.extend({}, a[d]), c.sources = e.filterSources(c.sources,
    ...
    var q = b.css = function(b, m, f) {
        ...
        var h = !1, q, p;
        for (q in m)
            p = l(q, m[q], f), "" !== p ? p !== j[q] && (j[q] = p, h = !0) : void 0 !== j[q] && (delete j[q], h = !0);
        if (h) {
            if (!e[b]) {
    ...
    h.scriptloader.loaders = {}
        ...
        function(h) {
            ...
            h.pad = function(c, h, j) {
                for (j || (j = "0"); c.length < h; )
                    c = j + c;
                return c
            };
            h.xmlAttribute = function(c, h) {
                for (var j = 0; j < c.attributes.length; j++)
                    if (c.attributes[j].name && c.attributes[j].name.toLowerCase() == h.toLowerCase())
    ...
    h.touch = function(j) {
        ...
        function b(a, b, c) {
            if (d[a] && (b.preventManipulation && b.preventManipulation(), b.preventDefault && b.preventDefault(), b = c ? c : e(a, b)))
                d[a](b)
        }
        function e(a, b) {
            var d = null;
    ...
    c.encrypt = function(g, b) {
        ...
        for (var n = c.strToLongs(j.encode(b).slice(0, 16)), a = e.length, d = e[a - 1], f = e[0], h, k = Math.floor(6 + 52 / a), m = 0; 0 < k--; ) {
            ...
            h = m >>> 2 & 3;
            for (var r = 0; r < a; r++)
                f = e[(r + 1) % a], d = (d >>> 5 ^ f << 2) + (f >>> 3 ^ d << 4) ^ (m ^ f) + (n[r & 3 ^ h] ^ d), d = e[r] += d
        }
        e = c.longsToStr(e);
        return l.encode(e)
    };
    c.decrypt = function(g, b) {
        ...
        for (var e = c.strToLongs(l.decode(g)), h = c.strToLongs(j.encode(b).slice(0, 16)), a = e.length,
            ...
            q = k >>> 2 & 3;
            for (var m = a - 1; 0 <= m; m--)
                d = e[0 < m ? m - 1 : a - 1], d = (d >>> 5 ^ f << 2) + (f >>> 3 ^ d << 4) ^ (k ^ f) + (h[m & 3 ^ q] ^ d), f = e[m] -= d;
            k -= 2654435769
        }
        e = c.longsToStr(e);
        e = e.replace(/\0+$/, "");
    ...
    c.strToLongs = function(c) {
        for (var b = Array(Math.ceil(c.length / 4)), e = 0; e < b.length; e++)
            b[e] = c.charCodeAt(4 * e) + (c.charCodeAt(4 * e + 1) << 8) + (c.charCodeAt(4 * e + 2) << 16) + (c.charCodeAt(4 * e + 3) << 24);
        return b
    };
    ...
    var l = {code: "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/\x3d", encode: function(c, b) {
            ...
            for (k = 0; k < m.length; k += 3)
                e = m.charCodeAt(k), h = m.charCodeAt(k + 1), a = m.charCodeAt(k + 2), d = e << 16 | h << 8 | a, e = d >> 18 & 63, h = d >> 12 & 63, a = d >> 6 & 63, d &= 63, f[k / 3] = r.charAt(e) + r.charAt(h) + r.charAt(a) +
                        r.charAt(d);
            f = f.join("");
            ...
            for (var r = 0; r < k.length; r += 4)
                e = m.indexOf(k.charAt(r)), h = m.indexOf(k.charAt(r + 1)), d = m.indexOf(k.charAt(r + 2)), f = m.indexOf(k.charAt(r + 3)), a = e << 18 | h << 12 | d << 6 | f, e = a >>> 16 & 255, h = a >>> 8 & 255, a &= 255, q[r / 4] = String.fromCharCode(e, h, a), 64 == f && (q[r / 4] = String.fromCharCode(e, h)), 64 == d && (q[r / 4] = String.fromCharCode(e));
            d = q.join("");
    ...
    h.plugin = function(j) {
        ...
        this.getPluginmode = function() {
            ...
            if ("undefined" != typeof a)
                return h.pluginmodes.FLASH;
            if ("undefined" != typeof d)
                return h.pluginmodes.JAVASCRIPT
        };
    ...
    (c.jwparser = function() {
        ...
        if (g.length) {
            ...
            for (n = 0; n < g.length; n++)
                0 < g[n].file.length && (g[n]["default"] = "true" == g[n]["default"] ? !0 : !1, g[n].label.length || delete g[n].label, j.sources.push(g[n]))
        }
        if (b.length) {
            j.tracks = [];
            for (n = 0; n < b.length; n++)
                0 < b[n].file.length && (b[n]["default"] = "true" == b[n]["default"] ?
            ...
            function(c) {
                ...
                if ("array" == h.utils.typeOf(c))
                    for (var j = 0; j < c.length; j++)
                        l.push(new h.playlist.item(c[j]));
                else
                    l.push(new h.playlist.item(c));
                return l
            }
}(jwplayer), function(h) {
    var c = h.item = function(l) {
        ...
        for (b = 0; b < g.sources.length; b++)
            e = g.sources[b]["default"], g.sources[b]["default"] = e ? "true" == e.toString() : !1, g.sources[b] = new h.source(g.sources[b]);
        if (g.captions && !j.exists(l.tracks)) {
            for (l = 0; l < g.captions.length; l++)
                g.tracks.push(g.captions[l]);
            delete g.captions
        }
    ...
    h.loader = function() {
        function b(b) {
            try {
                ...
                "xml" == g.localName(b) &&
                        (b = b.nextSibling);
                if ("rss" != g.localName(b))
                    n("Not a valid RSS feed");
                else {
    ...
    j.controller = function(a, d) {
        ...
        function x(e, f) {
            ...
            if (g.reconcile) {
                ...
                if (!m.id || !g.appid || !g.pageUrl)
                    m.id = c().id, g.appid = J.appid, g.pageUrl = Q, K = w = null;
        ...
        function H(c) {
            if ("state" === c.type) {
                if (y && (c.diff.newstate || c.diff.position))
                    y.destroy(), y = null, d.setVideo(z), d.sendEvent(b.JWPLAYER_CAST_AD_CHANGED, {done: !0});
                ...
                "connection" === c.type ? !0 === c.closed && A() : j.error("received unhandled message", c.type, c)
        }
        function E() {
                ...
                if (b.hasOwnProperty(e)) {
                    ...
                    if (f.client && (/[\.\/]/.test(f.client) && l(f, "client"), -1 < f.client.indexOf("vast"))) {
                        ...
                        if (f.schedule) {
                            var m = void 0;
                            for (m in f.schedule)
                                f.schedule.hasOwnProperty(m) && l(f.schedule[m].ad || f.schedule[m], "tag")
                        }
                        l(f, "tag");
                        c.advertising = f
                    }
        ...
        if (J.appid && (!h.cast || !h.cast.receiver))
            j.loader.addEventListener("availability", m), j.loader.addEventListener("session", r), j.loader.initialize(J.appid);
        ...
        d.updateModel = function(a, c) {
            ...
            if ("ad" !== c) {
                if (void 0 !== a.position || void 0 !== a.duration)
                    void 0 !== a.position && (q.position = a.position), void 0 !== a.duration && (q.duration = a.duration), d.sendEvent(b.JWPLAYER_MEDIA_TIME, {position: q.position, duration: q.duration});
    ...
    var j = h.utils, g = h.events, b = !0, e = !1, n = document, a = h.embed = function(d) {
        function f() {
            if (!B)
                if ("array" === j.typeOf(u.playlist) && 2 > u.playlist.length && (0 === u.playlist.length || !u.playlist[0].sources || 0 === u.playlist[0].sources.length))
                    m();
                else if (!F)
                    if ("string" === j.typeOf(u.playlist))
                        C = new h.playlist.loader, C.addEventListener(g.JWPLAYER_PLAYLIST_LOADED,
                                function(a) {
                        ...
                        for (var k = 0; k < u.modes.length; k++)
                            if (u.modes[k].type && a[u.modes[k].type]) {
                                ...
                                if (n.supportsConfig())
                                    return n.addEventListener(g.ERROR, q), n.embed(), j.css("object.jwswf, .jwplayer:focus", {outline: "none"}), j.css(".jw-tab-focus:focus", {outline: "solid 2px #0B7EF4"}), c(d,
                                            l.events), d
                            }
                        var p;
    ...
    (h.embed.flash = function(b, e, n, a, d) {
        ...
        this.embed = function() {
            n.id = d.id;
            if (10 > r)
                return m.sendEvent(l.ERROR, {message: "Flash version must be 10.0 or greater"}), !1;
                ...
                if (n) {
                    ...
                    try {
                        ...
                        for (var b = 0; b < a.length; b++)
                            if (a[b].file && g(a[b].file, a[b].type))
                                return!0
                    } catch (d) {
                    }
                } else
    ...
    var g = h.embed.flashCanPlay = function(b, e) {
        if (c.isYouTube(b) || c.isRtmp(b, e) || "hls" == e)
            return!0;
    ...
    h.embed.html5 = function(b, e, j, a, d) {
        ...
        k.embed = function() {
            if (h.html5) {
                ...
                c = new l.scriptloader(e.src), c.addEventListener(g.ERROR, q), c.addEventListener(g.COMPLETE, k.embed), c.load()
        };
            ...
            if (h.vid.canPlayType)
                try {
                    ...
                    for (var a = j.playlist[0].sources, b = 0; b < a.length; b++)
                        if (c(a[b].file, a[b].type, j.androidhls))
                            return!0
                } catch (d) {
                }
            return!1
    ...
    h.api = function(l) {
        ...
        p.detachMedia = function() {
            if ("html5" == p.renderingMode)
                return t("jwDetachMedia")
        };
        p.attachMedia = function(a) {
            if ("html5" == p.renderingMode)
                return t("jwAttachMedia", a)
        };
